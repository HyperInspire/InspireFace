...
HSUCCEED = 0  # Success
HERR_BASIC_BASE = 1  # Basic error types
...
HERR_SESS_BASE = 100  # Session error types (100)
...
HERR_FT_HUB_BASE = 200  # FeatureHub error types (200)
...
HERR_ARCHIVE_BASE = 250  # Archive error types (250)
...
HERR_DEVICE_BASE = 300  # Hardware error types (300)
...
HERR_EXTENSION_BASE = 350  # Extension module error types (350)
