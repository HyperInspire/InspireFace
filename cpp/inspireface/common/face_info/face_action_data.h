...
enum FACE_ACTION { NORMAL = 0, SHAKE = 0, BLINK = 1, JAW_OPEN = 2, RAISE_HEAD = 3 };
...
public:
    ...
    FaceActions AnalysisFaceAction() {
        ...
        if (index < record_list.size()) {
            ...
            float mouth_widthwise_d = record_list[0][FaceLandmark::MOUTH_LEFT_CORNER].Distance(record_list[0][FaceLandmark::MOUTH_RIGHT_CORNER]);
            float mouth_heightwise_d = PointDistance(record_list[0][FaceLandmark::MOUTH_UPPER], record_list[0][FaceLandmark::MOUTH_LOWER]);
